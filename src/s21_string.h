...
#define S21_LLONG_MAX 0x7fffffffffffffff
#define S21_LLONG_MIN (-S21_LLONG_MAX - 1LL)
#define S21_ULLONG_MAX 0xffffffffffffffff
...
static const char* const s21_error[ARRAY_SIZE] = {
    "Undefined error: 0",
